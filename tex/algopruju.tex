...
\usepackage[top=1.5cm, bottom=1cm, left=0cm, right=0cm]{geometry}
\frenchspacing
...
\lstinputlisting[language=C++]{../src/factorize.cpp}
\newpage
...
\lstinputlisting[language=C++]{../src/rabin_karp.cpp}
\subsection{Suffix array}
\lstinputlisting[language=C++]{../src/suffix_array.hh}
\subsection{Lexicographically minimal string rotation}
\lstinputlisting[language=C++]{../src/minimal_string_rotation.cpp}
\newpage
...
\lstinputlisting[language=C++]{../src/segtree_sparse.cpp}
